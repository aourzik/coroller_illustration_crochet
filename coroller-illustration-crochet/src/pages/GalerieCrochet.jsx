        ...
        <div style={{ 
            ...
            <div style={{ 
                ...
                <div style={{ maxWidth: 800, margin: "0 auto clamp(48px, 10vw, 80px)", textAlign: "center" }}>
                    <h1 style={{ 
                        ...
                        Toutes mes Créations de Crochet
                    </h1>
                    ...
                    <p style={{ 
                        ...
                        Je crée des peluches en crochet à offrir ou bien pour se faire plaisir, pour un anniversaire...
                    </p>
            ...
            {openIndex !== null && (
                <Lightbox
                    ...
                    onPrev={() => setOpenIndex((i) => (i - 1 + allCroch.length) % allCroch.length)}
                    onNext={() => setOpenIndex((i) => (i + 1) % allCroch.length)}
                />
            )}
        </div>
    );
